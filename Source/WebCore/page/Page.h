...
public:
    ...
    std::optional<MonotonicTime> nextRenderingUpdateTimestamp() const { return m_nextRenderingUpdateTimestamp; }
...
private:
    ...
    std::optional<MonotonicTime> m_nextRenderingUpdateTimestamp;
#if ENABLE(ACCESSIBILITY_ISOLATED_TREE)
